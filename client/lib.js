'use strict';
/* globals Meteor, GroundUser, _, Accounts */
...
var cleanObjectForUpdate = function(obj) {
	...
	for (var k in obj) {
		if (_.isFunction(obj[k]) || k.indexOf('$') > -1) {
			delete obj[k];
		}
	}
	delete obj._id;
...
Meteor.autorun(function() {
	...
	if (!groundUser || !_.isObject(groundUser)) {
		return GroundUser.insert(user);
	}

	var modifier = {
		$set: cleanObjectForUpdate(user)
	};
